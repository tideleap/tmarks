        ...
        {!readOnly && (
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`w-8 h-8 sm:w-9 sm:h-9 rounded-xl flex items-center justify-center font-bold text-lg sm:text-xl transition-all shadow-float touch-manipulation ${
                showCreateForm
      ...
      <div className="mb-4 sm:mb-5 space-y-3">
        ...
        <div className="inline-flex items-center justify-between w-full rounded-xl bg-muted p-1">
          ...
          <button
            ...
            className={`flex-1 py-2 px-2 rounded-lg transition-all flex items-center justify-center ${
              sortBy === 'usage'
    ...
    >
      ...
      <div className={`relative z-10 ${layoutClasses}`}>
        <div className={`flex items-center gap-2 ${layout === 'masonry' ? '' : 'flex-1 min-w-0'}`}>
          ...
          <span
            className={`text-xs ${layout === 'masonry' ? 'whitespace-nowrap' : 'truncate flex-1'} ${
