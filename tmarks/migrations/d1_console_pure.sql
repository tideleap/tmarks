...
CREATE TABLE IF NOT EXISTS bookmarks (id TEXT PRIMARY KEY, user_id TEXT NOT NULL, title TEXT NOT NULL, url TEXT NOT NULL, description TEXT, cover_image TEXT, favicon TEXT, has_snapshot INTEGER NOT NULL DEFAULT 0, latest_snapshot_at TEXT, snapshot_count INTEGER NOT NULL DEFAULT 0, is_pinned INTEGER NOT NULL DEFAULT 0, is_archived INTEGER NOT NULL DEFAULT 0, is_public INTEGER NOT NULL DEFAULT 0, click_count INTEGER NOT NULL DEFAULT 0, last_clicked_at TEXT, created_at TEXT NOT NULL DEFAULT (datetime('now')), updated_at TEXT NOT NULL DEFAULT (datetime('now')), deleted_at TEXT, FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE, UNIQUE(user_id, url));
...
CREATE TABLE IF NOT EXISTS user_preferences (user_id TEXT PRIMARY KEY, theme TEXT NOT NULL DEFAULT 'light', page_size INTEGER NOT NULL DEFAULT 30, view_mode TEXT NOT NULL DEFAULT 'list', density TEXT NOT NULL DEFAULT 'normal', tag_layout TEXT NOT NULL DEFAULT 'grid', sort_by TEXT NOT NULL DEFAULT 'popular', search_auto_clear_seconds INTEGER NOT NULL DEFAULT 15, tag_selection_auto_clear_seconds INTEGER NOT NULL DEFAULT 30, enable_search_auto_clear INTEGER NOT NULL DEFAULT 1, enable_tag_selection_auto_clear INTEGER NOT NULL DEFAULT 0, default_bookmark_icon TEXT NOT NULL DEFAULT 'bookmark', snapshot_retention_count INTEGER NOT NULL DEFAULT 5, snapshot_auto_create INTEGER NOT NULL DEFAULT 0, snapshot_auto_dedupe INTEGER NOT NULL DEFAULT 1, snapshot_auto_cleanup_days INTEGER NOT NULL DEFAULT 0, updated_at TEXT NOT NULL DEFAULT (datetime('now')), FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE);
